...
import MemoriesWorld from './screens/MemoriesWorld'
import RecipesWorld from './screens/RecipesWorld'
...
const WORLDS = {
  ...
  hub: HubScreen,
  studio: StudioScreen,
  memories: MemoriesWorld,
  recipes: RecipesWorld,
} as const
...
export default function App() {
  ...
  const handleOpenWorld = (world: 'hub' | 'studio' | 'memories' | 'recipes') => {
    setWorld(world)
  }
  ...
  // Mostrar tela de conclusão quando todos os 3 easter eggs forem encontrados
  useEffect(() => {
    if (easterEggs.length === 3 && prevEggCount.current < 3) {
